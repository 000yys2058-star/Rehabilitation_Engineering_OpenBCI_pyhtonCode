...
노트북의 **「내 보드 찾기 · MAC 주소 스캔」 셀**을 실행하면 됩니다. 추가 도구가 필요 없습니다.

동글에 BGAPI 명령을 직접 보내 주변 BLE 장치를 스캔하고,
Ganglion 목록을 **MAC 주소 · 신호 세기와 함께** 보여줍니다.

```
================================================================
Ganglion 보드 3개 발견
================================================================
  Ganglion-3587        d2:b4:11:81:48:ad   신호  -42 dBm
  Ganglion-1042        e1:9c:33:7a:21:b8   신호  -71 dBm
  Ganglion-2295        c8:5b:1f:04:9d:e2   신호  -78 dBm

가장 가까운 보드 : Ganglion-3587
3단계에 이렇게 적으세요 :
    BOARD_MAC = 'd2:b4:11:81:48:ad'
```

### 여러 대 중 내 보드 고르기 — 신호 세기 활용

**RSSI 는 0에 가까울수록 가까운 보드**입니다 (-42 가 -78 보다 가까움).

1. 내 보드를 **동글 바로 옆에 붙여** 놓는다
2. 스캔 셀 실행
3. 신호가 가장 강한 것이 내 보드
4. 그 MAC 을 `BOARD_MAC` 에 붙여넣고 3단계 재실행

**보드별 MAC 을 한 번 정리해 두면** 이후 수업에서 계속 재사용할 수 있습니다.

> 외부 도구를 쓰고 싶다면: Windows 는 **Bluetooth LE Explorer**(Microsoft Store),
> 폰은 **nRF Connect**(안드로이드만 — iOS 는 개인정보 정책상 실제 MAC 을 감춥니다).
> 다만 노트북 스캔 셀이 더 간단하고 RSSI 까지 보여줍니다.
